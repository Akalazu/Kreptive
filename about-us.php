    ...
    <div class="row align-items-center">
      ...
      <div class="col-lg-6 ps-xl-5 mt-5 mt-md-1">
        <div class="about-content-wrap">
          <h2 class="mb-3">About Niffiti</h2>
          <p>
            At Niffiti, we are passionate about bringing the world of digital art to life through blockchain technology. Our platform serves as a gateway for artists, collectors, and enthusiasts to explore, create, and trade unique digital assets known as Non-Fungible Tokens (NFTs).
          </p>
          <p>
            Whether you're an artist looking to showcase your talent, a collector seeking exclusive digital assets, or simply an enthusiast eager to explore the world of NFTs, Niffiti welcomes you to join our growing community.
            <br />
