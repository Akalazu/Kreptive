...
if (isset($_POST['send_proof'])) {
    ...
    if ($_FILES['upload_doc']['name'] != '') {
        ...
        $store = "uploads/me_depo/" . $newfileName;
        $location = '../' . $store;
                                                ...
                                                <div class="notes">
                                                    ...
                                                    <div style="text-align: center;">
                                                        ...
                                                        <div class="notes__code" style="max-width: max-content;">
                                                            ...
                                                            <input type="text" class="form-control" value="0x755912067aF4a45247dBc97cAD1643d0586D6361" id="textInput" hidden="" readonly="">

                                                            <span style="word-break: break-word; font-size:14px">0x755912067aF4a45247dBc97cAD1643d0586D6361</span>
                                                    ...
                                                    <div style="text-align: center;">
                                                        ...
                                                        <img src="https://api.qrserver.com/v1/create-qr-code/?data=0x755912067aF4a45247dBc97cAD1643d0586D6361&size=240x240">
                                                    </div>
