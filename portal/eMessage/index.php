...
<div class="container chat-list-container">
  <div class="content-sidebar-title">Niffiti Community</div>
  ...
  <div class="alert alert-success d-flex align-items-center p-4" role="alert">
    ...
    <div class="ml-3" style="font-size: 13px;">
      ...
      Welcome to Niffiti — the community for art enthusiasts! Connect, engage, and explore creative conversations with fellow creators.
    </div>
  </div>
  <div class="chat-list">
      ...
      <div class="chat-item d-flex justify-content-between align-items-center">
        <div class="d-flex align-items-center">
          ...
          <div class="chat-details ml-3">
            ...
            <p class="chat-preview mb-0 text-muted"> <?= $user->bio ?? "Hello there! I'll love to connect here on Niffiti Community" ?></p>
          </div>
        </div>
